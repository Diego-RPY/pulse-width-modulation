...
Designed a custom built PWM along with a state machine with logic gates. The PWM operated at a frequency of 500 Hz and was built using VERILOG language in Intel Quartus.
